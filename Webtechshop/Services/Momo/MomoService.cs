...
using Microsoft.AspNetCore.Http; // Cần thiết cho IQueryCollection
...
namespace Webtechshop.Services.Momo
{
    public class MomoService : IMomoService
    {
        ...
        public async Task<MomoCreatePaymentResponseModel> CreatePaymentMomo(OrderInfomation model)
        {
            ...
            string orderInfo = Uri.EscapeDataString(model.OrderInfo);
